...
import { X, Target, Users, Megaphone } from 'lucide-react';
            ...
            <div className="bg-gradient-to-r from-purple-900 to-indigo-800 p-6 relative flex-shrink-0">
              ...
              <div className="relative z-10 pr-8">
                ...
                <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-white mb-2 leading-tight">
                  Promoción digital activa
                </h2>
                <p className="text-indigo-100 text-sm md:text-base max-w-lg mt-2">
                  Llevamos tu auto a compradores activos en la región.
                </p>
              </div>
            ...
            <div className="p-6 md:p-8 overflow-y-auto custom-scrollbar flex-grow bg-white">
              <div className="space-y-6">
                ...
                <p className="text-gray-700 text-lg font-medium leading-relaxed border-b border-gray-100 pb-6">
                  Invertimos en campañas pagadas de <span className="font-bold text-blue-600">Meta Ads</span> y <span className="font-bold text-red-500">Google Ads</span> para mostrar tu auto a compradores activos en Baja California. Además lo ofrecemos a la cartera de clientes con la que ya estamos en contacto.
                </p>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-gray-900 mb-1">Segmentación regional</h3>
                    <p className="text-gray-600 leading-relaxed text-sm md:text-base">
                      Nuestros anuncios se orientan a personas que están buscando comprar un auto en Baja California, filtrando por intereses, ubicación y perfil de compra.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-gray-900 mb-1">Cartera de compradores activos</h3>
                    <p className="text-gray-600 leading-relaxed text-sm md:text-base">
                      Mantenemos contacto con compradores activos en la región. En algunos casos, hay interés cualificado para tu modelo desde el primer momento; en otros, la promoción se activa hasta encontrar al comprador adecuado.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed text-sm md:text-base">
                      Tu auto aparece en Facebook, Instagram, Google, nuestro sitio web y portales especializados, ampliando la visibilidad ante compradores potenciales.
                    </p>
                  </div>
                </div>
